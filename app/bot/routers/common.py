...
async def start(message: Message, users: UsersService):
    ...
    if actor_role == "student":
        lines.extend([
            ...
            "",
            "📚 Начните с просмотра недель: /week",
            "📥 Или отправьте решение: /submit [task_id]",
            "📅 Посмотрите свободные слоты: /slots"
        ])
    elif actor_role == "ta":
        lines.extend([
            f"<b>Ваша роль:</b> преподаватель", 
            "",
            "📅 Создайте расписание: /schedule",
            "🔍 Посмотрите свои слоты: /myslots",
        ...
        lines.extend([
            ...
            "👥 Управление: /weeks_list, /assign_student",
            "📊 Статистика: /ta_pending"
        ])
    else:
